...
<div style="display: flex; gap: 20px; margin-top: 15px;">
    ...
    <div class="form-group" style="flex: 1;">
        <label for="week2Name">Week 2 Name:</label>
        <input type="text" id="week2Name" name="week2Name" placeholder="e.g., HTML Elements" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="week2Desc">Week 2 Description:</label>
        <input type="text" id="week2Desc" name="week2Desc" placeholder="e.g., Tags, attributes, layout" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="week2Link">Week 2 Link:</label>
        <input type="url" id="week2Link" name="week2Link" placeholder="e.g., https://example.com/class2" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="week2Files">Week 2 PDFs / Images:</label>
        <input type="file" id="week2Files" name="week2Files[]" multiple accept="image/*, application/pdf" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="week2LongDesc">Week 2 Long Description:</label>
        <textarea id="week2LongDesc" name="week2LongDesc" placeholder="Write detailed description here..." required></textarea>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="specialNoticeW2">Special Notice in Week 2:</label>
        <textarea id="specialNoticeW2" name="specialNoticeW2" placeholder="Any important notes..." required></textarea>
    </div>
</div>
...
<div style="display: flex; gap: 20px; margin-top: 30px;">
    <div class="form-group" style="flex: 1;">
        <label for="week3Name">Week 3 Name:</label>
        <input type="text" id="week3Name" name="week3Name" placeholder="e.g., CSS Introduction" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="week3Desc">Week 3 Description:</label>
        <input type="text" id="week3Desc" name="week3Desc" placeholder="e.g., Styling basics, selectors" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="week3Link">Week 3 Link:</label>
        <input type="url" id="week3Link" name="week3Link" placeholder="e.g., https://example.com/class3" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="week3Files">Week 3 PDFs / Images:</label>
        <input type="file" id="week3Files" name="week3Files[]" multiple accept="image/*, application/pdf" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="week3LongDesc">Week 3 Long Description:</label>
        <textarea id="week3LongDesc" name="week3LongDesc" placeholder="Write detailed description here..." required></textarea>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="specialNoticeW3">Special Notice in Week 3:</label>
        <textarea id="specialNoticeW3" name="specialNoticeW3" placeholder="Any important notes..." required></textarea>
    </div>
</div>
                    Week 4
...
<div style="display: flex; gap: 20px; margin-top: 30px;">
    <div class="form-group" style="flex: 1;">
        <label for="week4Name">Week 4 Name:</label>
        <input type="text" id="week4Name" name="week4Name" placeholder="e.g., Advanced CSS Layouts" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="week4Desc">Week 4 Description:</label>
        <input type="text" id="week4Desc" name="week4Desc" placeholder="e.g., Flexbox, Grid systems" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="week4Link">Week 4 Link:</label>
        <input type="url" id="week4Link" name="week4Link" placeholder="e.g., https://example.com/class4" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="week4Files">Week 4 PDFs / Images:</label>
        <input type="file" id="week4Files" name="week4Files[]" multiple accept="image/*, application/pdf" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="week4LongDesc">Week 4 Long Description:</label>
        <textarea id="week4LongDesc" name="week4LongDesc" placeholder="Write detailed description here..." required></textarea>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="specialNoticeW4">Special Notice in Week 4:</label>
        <textarea id="specialNoticeW4" name="specialNoticeW4" placeholder="Any important notes..." required></textarea>
    </div>
</div>
...
<div style="display: flex; gap: 20px; margin-top: 40px;">
    <div class="form-group" style="flex: 1;">
        <label for="specialClassName">Special Class Name:</label>
        <input type="text" id="specialClassName" name="specialClassName" placeholder="e.g., Revision Session / Doubt Clearing" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="specialClassDesc">Special Class Description:</label>
        <input type="text" id="specialClassDesc" name="specialClassDesc" placeholder="e.g., Extra revision + Q&A" required>
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="specialClassLink">Special Class Link:</label>
        <input type="url" id="specialClassLink" name="specialClassLink" placeholder="e.g., https://example.com/special-class" required>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="specialClassFiles">Special Class PDFs / Images:</label>
        <input type="file" id="specialClassFiles" name="specialClassFiles[]" multiple accept="image/*, application/pdf">
    </div>
</div>

<div style="display: flex; gap: 20px; margin-top: 15px;">
    <div class="form-group" style="flex: 1;">
        <label for="specialClassLongDesc">Special Class Long Description:</label>
        <textarea id="specialClassLongDesc" name="specialClassLongDesc" placeholder="Explain the full details of the special class..." required></textarea>
    </div>

    <div class="form-group" style="flex: 1;">
        <label for="specialNoticeSC">Special Notice (Special Class):</label>
        <textarea id="specialNoticeSC" name="specialNoticeSC" placeholder="Any important instructions..." required></textarea>
    </div>
</div>
